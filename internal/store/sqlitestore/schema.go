...
CREATE INDEX IF NOT EXISTS idx_mcp_oauth_tokens_server_tenant ON mcp_oauth_tokens (server_id, tenant_id);`,
	...
	// Version 52 → 53: multi-user identity tables (users, user_sessions, user_tenant_links).
	52: addUserIdentityTables,
	// Version 53 → 54: user-owned LLM providers.
	53: addUserProvidersTable,
}
