...
export function SetupLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh items-start justify-center bg-background px-4 py-8 sm:items-center [--card:var(--background)]">
      <div className="w-full max-w-2xl space-y-6 overflow-y-auto max-h-dvh pb-12">
